...
export function GTSLandingPage({ onLogin, onNavigateToUIKit, onNavigateToDemo, onNavigateToB2BPortal, onNavigateToNewLeadDemo }: GTSLandingPageProps) {
  ...
  return (
    <div className="min-h-screen">
      ...
      <main>
        <section id="hero">
          <GTSHeroSection onLogin={onLogin} />
        </section>
